...
tri1 <-  c(1,2,3,0,0,2,0)
tri2 <- c(2,1,3,2,0,0,0,1,2,0,0,0,0,0,0)
sb(tri1,tri2)
# count differences up to common depth
which(tri1!=tri2[1:7])
length(which(tri1!=tri2[1:7]))
# count differences for lower layer of deepter tree to all 0 entries
...
# test case : 2 trees of different depth, more than 1 layer f difference
tri1 <-  c(1,2,3,0,0,2,0)
tri2 <- c(2,1,3,2,rep(0,3),1,2,rep(0,6),2,3,rep(0,14))
sb(tri1,tri2)

# we should not devide by the number of nodes of the larger full binary tree
